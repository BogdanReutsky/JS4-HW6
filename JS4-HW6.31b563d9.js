...
button.addEventListener("click", ()=>{
    const { r, g, b } = (0, _randomJs.random)();
    randomColor.style.backgroundColor = `rgb(${r},${g},${b})`;
    const { top, left } = (0, _randomJs.move)();
    randomColor.style.top = `${top}px`;
    randomColor.style.left = `${left}px`;
});

},{"./random.js":"fYPP6"}],"fYPP6":[function(require,module,exports,__globalThis) {
...
function move() {
    let top = Math.round(Math.random() * 799 + 1);
    let left = Math.round(Math.random() * 799 + 1);
    return {
        top,
        left
    };
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire2fb4", {})

//# sourceMappingURL=JS4-HW6.31b563d9.js.map
